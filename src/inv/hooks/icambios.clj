(ns inv.hooks.icambios
  "Business logic hooks for icambios entity.
...
(defn before-load
  ...
  (println "[INFO] Loading icambios with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "icambios record(s)")
...
(defn after-save
  ...
  (println "[INFO] Icambios saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if icambios can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Icambios deleted successfully. ID:" entity-id)
  {:success true})
