(ns inv.hooks.provedores
  "Business logic hooks for provedores entity.
...
(defn before-load
  ...
  (println "[INFO] Loading provedores with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "provedores record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving provedores...")
...
(defn after-save
  ...
  (println "[INFO] Provedores saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if provedores can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Provedores deleted successfully. ID:" entity-id)
  {:success true})
