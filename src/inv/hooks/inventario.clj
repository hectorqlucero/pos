(ns inv.hooks.inventario
  "Business logic hooks for inventario entity.
...
(defn before-load
  ...
  (println "[INFO] Loading inventario with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "inventario record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving inventario...")
...
(defn after-save
  ...
  (println "[INFO] Inventario saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if inventario can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Inventario deleted successfully. ID:" entity-id)
  {:success true})
