...
(defn generate-edn-content
  ...
  (let [entity-name (name (:entity config))
    ...
    (str ";; AUTO-GENERATED entity configuration for " (:table config) "\n"
         ...
         " ;; :hooks {:before-load :inv.hooks." entity-name "/before-load\n"
         " ;;         :after-load :inv.hooks." entity-name "/after-load\n"
         " ;;         :before-save :inv.hooks." entity-name "/before-save\n"
         " ;;         :after-save :inv.hooks." entity-name "/after-save\n"
         " ;;         :before-delete :inv.hooks." entity-name "/before-delete\n"
         " ;;         :after-delete :inv.hooks." entity-name "/after-delete}\n"
