...
- `src/inv/hooks/products.clj` - Hook stub file (for senior)
...
Edit `src/inv/hooks/products.clj`:

```clojure
(ns inv.hooks.products
...
{:entity :products
 ...
 ;; UNCOMMENT THIS:
 :hooks {:before-save :inv.hooks.products/before-save
         :after-save :inv.hooks.products/after-save}}
```
...
3. **Implement Hooks** in `src/inv/hooks/`
...
2. Namespace is correct (:inv.hooks.products/before-save)
...
- Senior edits: `src/inv/hooks/*.clj`
